                        ...
                        <div className="testimonial-activation testimonial-pb mb--30">
                                ...
                                <div className="inner">
                                    <div className="card-info">
                                        <div className="card-thumbnail">
                                            <img src="/src/images/3d/01.png" alt="Testimonial-image"/>
                                        </div>
                                    ...
                                    <div className="card-description">
                                        <div className="title-area">
                                            ...
                                            <div className="rating">
                                                <img src="/src/images/icons/rating.png" alt="rating-image"/>
                                                <img src="/src/images/icons/rating.png" alt="rating-image"/>
                                                <img src="/src/images/icons/rating.png" alt="rating-image"/>
                                                <img src="/src/images/icons/rating.png" alt="rating-image"/>
                                                <img src="/src/images/icons/rating.png" alt="rating-image"/>
                            ...
                            <div className="testimonial mt--50 mt_md--40 mt_sm--40">
                                <div className="inner">
                                    <div className="card-info">
                                        <div className="card-thumbnail">
                                            <img src="/src/images/3d/Saly-11.png" alt="Testimonial-image"/>
                                        </div>
                                        <div className="card-content">
                            ...
                            <div className="testimonial mt--50 mt_md--40 mt_sm--40">
                                <div className="inner">
                                    <div className="card-info">
                                        <div className="card-thumbnail">
                                            <img src="/src/images/3d/Saly-22.png" alt="Testimonial-image"/>
                                        </div>
                                        <div className="card-content">
                            ...
                            <div className="testimonial mt--50 mt_md--40 mt_sm--40">
                                <div className="inner">
                                    <div className="card-info">
                                        <div className="card-thumbnail">
                                            <img src="/src/images/3d/Saly-19.png" alt="Testimonial-image"/>
                                        </div>
                                        <div className="card-content">
