                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true" className="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div className="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                            <div className="inner">
                                <div className="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="/src/images/Dribbble/02.png" alt="Personal Portfolio Images"/>
                                    </a>
                                </div>
                                <div className="content">
                                    <div className="category-info">
                    ...
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-once="true" className="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div className="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                            <div className="inner">
                                <div className="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="/src/images/Dribbble/04.png" alt="Personal Portfolio Images"/>
                                    </a>
                                </div>
                                <div className="content">
                                    <div className="category-info">
                                    ...
                                    <h4 className="title"><a href="javascript:void(0)">Mobile app landing design &
                                            Services<i className="feather-arrow-up-right"></i></a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                            <div className="inner">
                                ...
                                <div className="content">
                                    ...
                                    <h4 className="title"><a href="javascript:void(0)">Design for tecnology & services<i
                                                className="feather-arrow-up-right"></i></a></h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" className="col-lg-6 col-xl-4 col-md-6 col-12 mt--50 mt_md--30 mt_sm--30">
                        <div className="rn-portfolio" data-toggle="modal" data-target="#exampleModalCenter">
                            <div className="inner">
                                <div className="thumbnail">
                                    <a href="javascript:void(0)">
                                        <img src="/src/images/Dribbble/06.png" alt="Personal Portfolio Images"/>
                                    </a>
                                </div>
                                <div className="content">
                                    <div className="category-info">
                                    ...
                                    <h4 className="title"><a href="javascript:void(0)">App for tecnology & services<i
                                                className="feather-arrow-up-right"></i></a></h4>
                                </div>
                            </div>
                        </div>
